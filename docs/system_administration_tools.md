...
**Note**: This is a specialized reference for system administration tools. For the complete CLI tools documentation with 327 commands across 35 categories, see [TOOLS.md](../TOOLS.md).
